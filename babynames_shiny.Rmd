...
Code is available on [github](https://github.com/rmcd1024/babynames_shiny). Comments are welcome on github or [email](mailto:rmcd1024@gmail.com). Note that:

* "Partial name match" will match every name containing the search string.
